...
#DiagGamma.append(read_data.read_array("../../data/3D/bare_L8_0.50_3_quantities.dat", Quan))
#DiagGamma.append(read_data.read_array("../../data/3D/bare_L4_0.70_4_quantities.dat", Quan))
#DiagGamma.append(read_data.read_array("../../project/0.50_10_04_quantities.dat", Quan))
#DiagGamma.append(read_data.read_array("../../project/0.50_10_24_quantities.dat", Quan))
#DiagGamma.append(read_data.read_array("../../project/0.50_10_41_quantities.dat", Quan))

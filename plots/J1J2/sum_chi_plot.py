...
SUMChi.append(read_data.read_array("../../data/3D/bare_L4_0.70_1_quantities.dat", Quans))
SUMChi.append(read_data.read_array("../../data/3D/bare_L4_0.70_2_quantities.dat", Quans))
SUMChi.append(read_data.read_array("../../data/3D/bare_L4_0.70_3_quantities.dat", Quans))
SUMChi.append(read_data.read_array("../../data/3D/bare_L4_0.70_4_quantities.dat", Quans))

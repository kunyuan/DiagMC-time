...
#BoldSigma.append(read_data.read_array("./bare_L4_0.50_5_quantities.dat",target))
#BoldSigma.append(read_data.read_array("./bare_L4_0.50_6_quantities.dat",target))
BoldSigma.append(read_data.read_array("./bare_L4_0.70_1_quantities.dat",target))
BoldSigma.append(read_data.read_array("./bare_L4_0.70_2_quantities.dat",target))
BoldSigma.append(read_data.read_array("./bare_L4_0.70_3_quantities.dat",target))
BoldSigma.append(read_data.read_array("./bare_L4_0.70_4_quantities.dat",target))

...
DiagGamma=[]
DiagGamma.append(read_data.read_array("L16_1.50_2/1.50_quantities.dat", Quan))
#DiagGamma.append(read_data.read_array("L32_2.00_6/2.00_quantities.dat", Quan))
...
plt.savefig("Beta1.50_diag_Gamma.pdf")
plt.show()

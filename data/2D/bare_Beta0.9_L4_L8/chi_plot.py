...
Files.append(read_data.read_array("./L4_0.90_6_quantities.dat", Quans))
...
#for key in Quans:
    ...
    #ax.errorbar(0.1, Chi_4_pi, marker='*', yerr=0.0003, label="L=4, beta=0.90, Path Integral")
    #ax.errorbar(0.1, Chi_8_pi, marker='*', yerr=0.0006, label="L=8, beta=0.90, Path Integral")
#ax.set_xlim(0.0, 1.0)

    ...
    do omega1 = 0, MxT-1
      ...
      do ityp = 1, 5
        do omega3 = 0, MxT-1
          ...
          Gam2 = GamMCInput((tgam2(ityp)+1)/2, 0, omega3, omegaout)+weight_Gam0(tgam2(ityp), 0)

          do isite1 = 0, Vol-1
            if(if_inside_Vol(D, GamL, isite1)) then
              do isite3 = 0, Vol-1
                if(if_inside_Vol(D, GamL, isite3)) then
                  isiteW = diff_r(D, isite1, isite3)
                  Gam1 = GamMCInput((tgam1(ityp)+1)/2, isite1, omega1, omega3)
                  Gam1 = Gam1 +weight_Gam0(tgam1(ityp), 0)
                  Gam3 = GamMCInput((tgam3(ityp)+1)/2, isite3, omegaout, omega2)
                  Gam3 = Gam3 +weight_Gam0(tgam3(ityp), 0)
